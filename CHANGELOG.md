...
- Added support for CIDR notation in `IpRangeInput`.

## [0.15.2] - 2026-04-22

### Changed

- Renamed direction labels `SRC`/`DST` to `ORIG`/`RESP` in the
  `complex-select` network/IP direction dropdown.
...
- Fixed minor visual issues (alignment, spacing, and icon styling only).
...
[Unreleased]: https://github.com/aicers/frontary/compare/0.15.2...main
[0.15.2]: https://github.com/aicers/frontary/compare/0.15.1...0.15.2
