...
use crate::{
    ...
    SelectMiniKind, SelectionExtraInfo, ViewString, select::complex::component::SelectionState,
    text, window_inner_height,
};
...
impl Model {
    ...
    pub(super) fn view_pop(&self, ctx: &Context<Self>) -> Html {
        ...
        let postfix = if cfg!(feature = "pumpkin") {
            if self.selection_state == SelectionState::AllSelected {
                "checked"
            } else {
                "unchecked"
            }
        ...
        let style_head_title: String = format!("width: {}px;", ctx.props().pop_width - 34);
        let get_expand_collapse_style = |visible: bool| {
            ...
            format!("background-image: url('/frontary/{prefix}{state}.{extension}');")
        };
        ...
        html! {
            <div id={ctx.props().id.clone()} class="complex-select-pop" style={style_pop} pumpkin={cfg!(feature = "pumpkin").to_string()}>
                    ...
                    if cfg!(feature = "pumpkin") {
                        ...
                        html! {
                            <div class="complex-select-pop-container">
                                <div class="complex-select-pop-all" onclick={onclick_all}>
                                    <div class="complex-select-pop-all-button" style={style_all}></div>
                                    <div class="complex-select-pop-all-text">
                                        { text!(txt, ctx.props().language, "Include all registered and custom IPs") }
                                    </div>
                                </div>
                                <div class="complex-select-pop-list-group">
                                ...
                                <div class="complex-select-pop-input-group">
                                            ...
                                            <>
                                                <div class="complex-select-pop-list-select-all-group">
                                                    <div class="complex-select-pop-list-select-all-checkbox">
                                                        <div class="complex-select-pop-list-select-all-checkbox-icon">
