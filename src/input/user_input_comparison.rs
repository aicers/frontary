    ...
    <T as Component>::Message: Clone + PartialEq,
{
    ...
    fn view_comparison_value(
        ...
        let indicator_class = if cfg!(feature = "appearance") {
            "input-comparison-value-indicator-padded"
        } else {
            "input-comparison-value-indicator"
        };

        let indicator_single_class = if cfg!(feature = "appearance") {
    ...
    fn view_comparison_value_each(
        ...
        let input_class = if cmp_kind.chain_cmp() && cfg!(feature = "appearance") {
